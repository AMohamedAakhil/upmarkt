  ...
  const onUpload = async (e: FileUploadHandlerEvent) => {
    ...
    await Promise.all(
      formDataArray.map((formData) =>
        axios
          .post(
            "https://api.cloudinary.com/v1_1/ddospzdve/image/upload",
            formData
          )
          .then((response) => {
    ...
    <div>
      ...
      {loading ? (
        ...
        <>
          ...
          <FileUpload multiple name="demo[]" customUpload uploadHandler={(e) => onUpload(e)} accept="image/*" maxFileSize={1000000} emptyTemplate={<p className="m-0">Drag and drop files to here to upload.</p>} />
