...
const EditProductForm = ({
  ...
  const form = useForm<z.infer<typeof productFormSchema>>({
    ...
    defaultValues: {
      ...
      description: previousFormValues.description
        ? previousFormValues.description
        : "",
      warranty: previousFormValues.warranty ? previousFormValues.warranty : "",
      categoryId: previousFormValues.categoryId
        ? previousFormValues.categoryId
        : "",
      productCode: previousFormValues.productCode
        ? previousFormValues.productCode
        : "",
      brandId: previousFormValues.brandId ? previousFormValues.brandId : "",
      unit: previousFormValues.unit ? previousFormValues.unit : "",
      unitPrice: String(
        previousFormValues.unitPrice ? previousFormValues.unitPrice : ""
      ),
      ...
      typeOfDiscount: previousFormValues.typeOfDiscount
        ? previousFormValues.typeOfDiscount
        : "",
      totalQuantity: String(
        previousFormValues.totalQuantity ? previousFormValues.totalQuantity : ""
      ),
      minimumQuantity: String(
        previousFormValues.minimumQuantity
          ? previousFormValues.minimumQuantity
          : ""
      ),
      shippingCost: String(
        previousFormValues.shippingCost ? previousFormValues.shippingCost : ""
      ),
      deliveryDuration: previousFormValues.deliveryDuration
        ? previousFormValues.deliveryDuration
        : "",
      shippingCostMultiplyByQuantity:
        previousFormValues.shippingCostMultiplyByQuantity ? "yes" : "no",
      metaTitle: previousFormValues.metaTitle
        ? previousFormValues.metaTitle
        : "",
      metaDescription: previousFormValues.metaDescription
        ? previousFormValues.metaDescription
        : "",
      metaImageUrl: previousFormValues.metaImageUrl
        ? previousFormValues.metaImageUrl
        : "",
      youtubeLink: previousFormValues.youtubeLink
        ? previousFormValues.youtubeLink
        : "",
      thumbnailUrl: previousFormValues.thumbnailUrl
        ? previousFormValues.thumbnailUrl
        : "",
      images: previousFormValues.images
        ? [...previousFormValues.images.map((item: any) => item.url)]
        : [],
      subCategoryId: previousFormValues.subCategoryId
        ? previousFormValues.subCategoryId
        : "",
    },
  });
                ...
                >
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Select attributes, and add attribute values. Press Enter
                        or add a "," to create new attribute values
                      </CardDescription>
                    </CardHeader>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        All pricing related info such as unit price, tax,
                        discounts, etc
                      </CardDescription>
                    </CardHeader>
